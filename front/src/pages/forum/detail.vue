<template>
  <div :style='{"width":"80%","padding":"0 20px","boxShadow":"none","margin":"20px auto","position":"relative","background":"rgb(255, 255, 255)"}'>
    <div :style='{"width":"100%","boxShadow":"none"}'>
		<div :style='{"padding":"0 10px","color":"#000","textAlign":"center","width":"100%","lineHeight":"54px","fontSize":"22px","fontWeight":"bold","height":"54px"}'>考研论坛</div>
	</div>
    ...
    <div class="section-content" :style='{"boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3)","padding":"0 20px","margin":"0 auto","flexWrap":"wrap","background":"rgb(255, 255, 255)","display":"flex","width":"100%","position":"relative"}'>
	  ...
	  <div :style='{"width":"50%","alignItems":"center","justifyContent":"flex-start","display":"flex"}'>
	    <div :style='{"padding":"0 20px 0 0","fontSize":"14px","color":"#9E9E9E","textAlign":"right"}'>发布人：{{detail.username}}</div>
      ...
      <div :style='{"padding":"20px 0","lineHeight":"1.5"}' class="content-detail" v-html="detail.content"></div>
		...
		<div :style='{"width":"100%","padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3)","margin":"20px 0"}'>
			<div :style='{"padding":"0 0 20px 0","borderColor":"#efefef","alignItems":"center","borderWidth":"0 0 1px 0","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"space-between"}'>
				<div :style='{"color":"#000","fontSize":"16px","fontWeight":"bold"}'>评论列表</div>
				<el-button class="pub" type="primary" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0 10px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#3B2E7E","width":"auto","fontSize":"14px","lineHeight":"32px","height":"32px"}' @click="addComment">
			...
			<div class="comment" :style='{"width":"100%"}'>
				...
				<div class="item" :style='{"border":"1px solid #DADADA","padding":"8px 0","margin":"20px 0 0 0","alignItems":"center","color":"#666","background":"#fff","borderWidth":"0 0 2px","width":"100%","height":"auto"}' v-for="item in commentList" :key="item.id" @mouseenter="commentEnter(item.id)" @mouseleave="commentLeave">
					...
					<div class="btn" :style='{"width":"100%","margin":"8px 0 0 0","alignItems":"center","justifyContent":"flex-end","display":"flex","height":"40px"}'>
						<el-button :style='{"border":"0","cursor":"pointer","padding":"0 20px","margin":"0 10px","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"4px","background":"#3B2E7E","width":"auto","lineHeight":"30px","fontSize":"14px","height":"30px"}' v-if="showIndex==item.id&&showIndex1 == -1" @click="replyClick(item.id)">回复</el-button>
						<el-button :style='{"border":"0","cursor":"pointer","padding":"0 20px","margin":"0 10px","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"4px","background":"#9F9F9F","width":"auto","lineHeight":"30px","fontSize":"14px","height":"30px"}' v-if="showIndex==item.id&&userid==item.userid&&showIndex1 == -1" @click="commentDel(item.id)">删除</el-button>
					</div>
					
					<template v-if="item.childs && item.childs.length">
					<div class="comment"  :style='{"width":"calc(100% - 50px)","padding":"0 20px","margin":"0 0 0 50px","background":"#FAFAFA"}'>
						<div class="item" :style='{"padding":"20px 0 0","margin":"0px 0 0 0","borderColor":"#D8D8D8","alignItems":"center","color":"#666","background":"none","borderWidth":"0 0 1px","width":"100%","borderStyle":"solid","height":"auto"}' v-for="items in item.childs" :key="items.id" @mouseenter="commentEnter1(items.id)" @mouseleave="commentLeave1">
							<div class="user" :style='{"width":"100%","alignItems":"center","display":"flex","height":"auto"}'>
							...
							<div class="btn" :style='{"width":"100%","margin":"8px 0 0 0","alignItems":"center","justifyContent":"flex-end","display":"flex","height":"40px"}'>
								<el-button :style='{"border":"0","cursor":"pointer","padding":"0 20px","margin":"0 10px","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"4px","background":"#9f9f9f","width":"auto","lineHeight":"30px","fontSize":"14px","height":"30px"}' v-if="showIndex==item.id&&userid==items.userid&&showIndex1==items.id" @click="commentDel(items.id)">删除</el-button>
							</div>
						</div>
					</div>
					</template>

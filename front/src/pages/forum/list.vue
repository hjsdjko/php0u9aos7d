<template>
<div class="forum-preview" :style='{"width":"80%","padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3)","margin":"10px auto","position":"relative","background":"#fff"}'>
    <div :style='{"width":"100%"}'>
	...
	<div class="z-box" :style='{"width":"100%","padding":"20px"}'>
		<div class="section-content" v-for="item in forumList" :key="item.id" @click="toForumDetail(item)">
		  <div :style='{"width":"calc(100% - 150px)","fontSize":"16px","lineHeight":"90px","color":"#000","fontWeight":"bold","height":"90px"}' class="item-style">{{item.title}}</div>
		  <div :style='{"margin":"15px 0 0 20px","color":"#fff","textAlign":"center","background":"#000000","width":"130px","fontSize":"14px","lineHeight":"30px"}' class="item-style">发布人：{{item.username}}</div>
		  <div :style='{"fontSize":"14px","lineHeight":"42px","color":"#909090","height":"42px"}' class="item-style">{{item.addtime}}</div>
		</div>
	</div>

...
<div class="content" :style='{"width":"100%","padding":"30px","margin":"0","overflow":"hidden","background":"rgba(0,0,0,0.5)"}'>
	...
	<div :style='{"margin":"0 0 20px 0","alignItems":"center","justifyContent":"center","display":"flex"}'>
		<div :style='{"boxShadow":"none","margin":"0 10px","borderColor":" rgba(0,0,0,0.4)","borderRadius":"4px","background":" rgba(0,0,0,0.3)","borderWidth":"1px 1px 1px 0","display":"flex","borderStyle":"solid"}' v-if="isAuth('yonghu','首页总数')">
			...
			<div :style='{"width":"160px","alignItems":"center","flexDirection":"column","background":"","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"20px","color":"#fff","fontWeight":"bold","height":"24px"}'>{{yonghuCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"16px","color":"#fff","height":"24px"}'>用户总数</div>
			</div>
		</div>
		<div :style='{"border":"1px solid  rgba(0,0,0,0.4)","boxShadow":"none","margin":"0 10px","borderRadius":"4px","background":" rgba(0,0,0,0.3)","display":"flex"}' v-if="isAuth('yuanxiaoxinxi','首页总数')">
			<div :style='{"width":"80px","alignItems":"center","background":" rgba(0,0,0,0.4)","justifyContent":"center","display":"flex","height":"80px"}'>
				<span class="icon iconfont icon-xihuan" :style='{"color":"#fff","fontSize":"24px"}'></span>
			</div>
			<div :style='{"width":"160px","alignItems":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"20px","color":"#fff","fontWeight":"bold","height":"24px"}'>{{yuanxiaoxinxiCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"16px","color":"#fff","height":"24px"}'>院校信息总数</div>
			</div>
		</div>
		<div :style='{"border":"1px solid  rgba(0,0,0,0.4)","boxShadow":"none","margin":"0 10px","borderRadius":"4px","background":" rgba(0,0,0,0.3)","display":"flex"}' v-if="isAuth('meiridaka','首页总数')">
			<div :style='{"width":"80px","alignItems":"center","background":" rgba(0,0,0,0.4)","justifyContent":"center","display":"flex","height":"80px"}'>
				<span class="icon iconfont icon-xihuan" :style='{"color":"#fff","fontSize":"24px"}'></span>
			</div>
			<div :style='{"width":"160px","alignItems":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"20px","color":"#fff","fontWeight":"bold","height":"24px"}'>{{meiridakaCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"16px","color":"#fff","height":"24px"}'>每日打卡总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<!-- 日历 -->
	<div class="calendar" :style='{"width":"700px","boxShadow":"0 2px 8px rgba(0,0,0,1)","margin":"20px auto","borderRadius":"16px","background":"rgba(0,0,0,0.2)","height":"auth"}'>
	  <div :style='{"width":"100%","padding":"20px","flexWrap":"wrap","justifyContent":"space-between","display":"flex","height":"auto"}'>
	    <div @click="pyear" :style='{"cursor":"pointer","border":"1px solid  rgba(0,0,0,0.4)","padding":"0 12px","alignItems":"center","color":"#fff","borderRadius":"4px","background":" rgba(0,0,0,0.4)","display":"flex","width":"auto","fontSize":"14px","justifyContent":"center","height":"40px"}'><span class="icon iconfont icon-fanhui" :style='{"color":"#fff","margin":"0 2px","fontSize":"16px"}'></span>上一年</div>
	    <div @click="pmonth" :style='{"cursor":"pointer","border":"1px solid  rgba(0,0,0,0.4)","padding":"0 12px","alignItems":"center","color":"#fff","borderRadius":"4px","background":"rgba(0,0,0,0.4)","display":"flex","width":"auto","fontSize":"14px","justifyContent":"center","height":"40px"}'><span class="icon iconfont icon-fanhui" :style='{"color":"#fff","margin":"0 2px","fontSize":"16px"}'></span>上一月</div>
	    <div :style='{"padding":"0 10px","alignItems":"center","justifyContent":"center","display":"flex"}'>
	      <div :style='{"color":"#fff","margin":"0 2px","fontSize":"24px"}'>{{this.year}}年</div>
	      <div :style='{"color":"#fff","margin":"0 2px","fontSize":"24px"}'>{{this.month}}月</div>
	    </div>
	    <div @click="nmonth" :style='{"cursor":"pointer","border":"1px solid  rgba(0,0,0,0.4)","padding":"0 12px","alignItems":"center","color":"#fff","borderRadius":"4px","background":"rgba(0,0,0,0.4)","display":"flex","width":"auto","fontSize":"14px","justifyContent":"center","height":"40px"}'>下一月<span class="icon iconfont icon-jinru" :style='{"color":"#fff","margin":"0 2px","fontSize":"16px"}'></span></div>
	    <div @click="nyear" :style='{"cursor":"pointer","border":"1px solid rgba(0,0,0,0.4)","padding":"0 12px","alignItems":"center","color":"#fff","borderRadius":"4px","background":"rgba(0,0,0,0.4)","display":"flex","width":"auto","fontSize":"14px","justifyContent":"center","height":"40px"}'>下一年<span class="icon iconfont icon-jinru" :style='{"color":"#fff","margin":"0 2px","fontSize":"16px"}'></span></div>
	  </div>
	  <table :style='{"width":"100%","padding":"0 0 10px","heith":"auto","borderRadius":"","background":"rgba(0,0,0,0.3)"}' v-if="this.weeks.length">
	    <thead :style='{"width":"100%","heith":"auto"}'>
	      <tr :style='{"width":"100%","heith":"auto","alignItems":"center","justifyContent":"center","display":"flex"}'>
	        <th :style='{"alignItems":"center","color":"#fff","flex":1,"display":"flex","lineHeight":"60px","fontSize":"16px","justifyContent":"center"}' v-for="item,index in this.heads" :key="index">{{item}}</th>
	      </tr>
	    </thead>
	...
	<div class="type3" :style='{"alignContent":"flex-start","padding":"10px 20px","flexWrap":"wrap","background":"rebeccapurple","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto"}'>
		...
		<div id="yuanxiaoxinxiChart1" class="echarts2" v-if="isAuth('yuanxiaoxinxi','首页统计')"></div>
		<div id="meiridakaChart1" class="echarts3" v-if="isAuth('meiridaka','首页统计')"></div>
	</div>
</div>
</template>
<script>
...
export default {
	...
	methods:{
        ...
        var yuanxiaoxinxiChart1 = echarts.init(document.getElementById("yuanxiaoxinxiChart1"),'macarons');
        this.$http({
            url: `yuanxiaoxinxi/value/yuanxiaomingcheng/zhaoshourenshu`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
        ...
        var meiridakaChart1 = echarts.init(document.getElementById("meiridakaChart1"),'macarons');
        this.$http({
            url: "meiridaka/group/yonghuxingming",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                meiridakaChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    meiridakaChart1.resize();
                };
            }
        });
      })

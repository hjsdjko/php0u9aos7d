<template>
  <div class="main-content" :style='{"padding":"30px","margin":" 0 0 30px","background":"rgba(0,0,0,0.5)"}'>
    <!-- 列表页 -->
    <div v-if="!showFlag">
      <el-form :style='{"padding":"30px","boxShadow":"none","borderRadius":"6px","alignItems":"flex-start","flexWrap":"wrap","display":"flex"}' :inline="true" :model="searchForm" class="add-update-preview">
        <el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' label="往届试题">
          <el-input v-model="searchForm.papername" placeholder="往届试题名称" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' label="试题">
          <el-input v-model="searchForm.questionname" placeholder="试题名称" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}'>

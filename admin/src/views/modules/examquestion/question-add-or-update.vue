<template>
  <div :style='{"padding":"30px","margin":" 0 0 30px","background":"rgba(0,0,0,0.5)"}'>
    <el-form
      ...
      label-width="180px"
    >
      <el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' label="选择往届试题" prop="paperid">
        <el-select @change="onPaperChange" v-model="ruleForm.paperid" placeholder="选择往届试题">
          <el-option
      ...
      <el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' label="试题" prop="questionname">
        <el-input
          type="textarea"
          min="1"
      ...
      <el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' label="类型" prop="type">
      ...
      <el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' v-if="ruleForm.type!=3&&ruleForm.type!=2&&ruleForm.type!=4" label="选项" prop="options">
      ...
      <el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' v-if="ruleForm.type==0 && options.length>0" label="答案" prop="answer">
      ...
      <el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' v-if="ruleForm.type==1 && options.length>0" label="答案" prop="answer">
      ...
      <el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' v-if="ruleForm.type==2 && options.length>0" label="答案" prop="answer">
        <el-select v-model="ruleForm.answer" @change="answerChange">
          <el-option
            :label="item.text"
            :value="item.code"
      ...
      <el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' v-if="ruleForm.type==3" label="答案" prop="answer">
        <el-input v-model="ruleForm.answer" placeholder="答案" clearable @input="answerChange"></el-input>
      </el-form-item>
      <el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' label="分数" prop="score">
        <el-input-number v-model="ruleForm.score" :min="1" :max="100" label="分数"></el-input-number>
      </el-form-item>
      <el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' label="分析" prop="analysis">
        <el-input
          type="textarea"
          min="1"
      ...
      <el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' label="排序" prop="sequence">
        <el-input-number v-model="ruleForm.sequence" :min="1" :max="20" label="排序"></el-input-number>
      </el-form-item>
      <el-form-item :style='{"padding":"0","margin":"0"}'>
		<el-button class="btn3" :style='{"border":"1px solid  rgba(0,0,0,0.3)","cursor":"pointer","padding":"0 24px","margin":"4px","outline":"none","color":"#fff","borderRadius":"4px","background":" rgba(0,0,0,0.3)","width":"auto","fontSize":"14px","height":"40px"}' type="success" @click="onSubmit">
			<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"40px"}'></span>
			提交
		</el-button>
		<el-button class="btn4" :style='{"border":"1px solid  rgba(0,0,0,0.3)","cursor":"pointer","padding":"0 24px","margin":"4px","outline":"none","color":"#fff","borderRadius":"4px","background":" rgba(0,0,0,0.3)","width":"auto","fontSize":"14px","height":"40px"}' type="success" @click="back()">
			<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"40px"}'></span>
			取消
		</el-button>
      </el-form-item>
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        paperid: [{ required: true, message: "请选择往届试题", trigger: "blur" }],
        questionname: [
